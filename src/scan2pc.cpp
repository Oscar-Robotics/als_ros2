...
class Scan2PC : public rclcpp::Node
{
  ...
  public:
    Scan2PC(void) : Node("als_scan_2_pc"), scanName_("/scan"), pcName_("/scan_point_cloud")
    {
        ...
        scanSub_ =
            this->create_subscription<sensor_msgs::msg::LaserScan>(scanName_, 1, [this](sensor_msgs::msg::LaserScan::SharedPtr msg) {
                this->scanCB(msg);
            });
        pcPub_ = this->create_publisher<sensor_msgs::msg::PointCloud>(pcName_, 1);
    }
