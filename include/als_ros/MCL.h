...
class MCL : public rclcpp::Node
{
  ...
  public:
    ...
    MCL(void)
        : Node("mcl", rclcpp::NodeOptions()), scanName_("/scan"), odomName_("/odom"), mapName_("/map"),
          poseName_("/mcl_pose"), particlesName_("/mcl_particles"), unknownScanName_("/unknown_scan"),
          residualErrorsName_("/residual_errors"), reliabilityName_("/reliability"),
          glSampledPosesName_("/gl_sampled_poses"), reliabilityMarkerName_("/reliability_marker_name"),
          laserFrame_("laser"), baseLinkFrame_("base_link"), mapFrame_("map"), odomFrame_("odom"), broadcastTF_(true),
          useOdomTF_(true), initialPoseX_(0.0), initialPoseY_(0.0), initialPoseYaw_(0.0), initialNoiseX_(0.02),
          initialNoiseY_(0.02), initialNoiseYaw_(0.02), particlesNum_(100), useAugmentedMCL_(false),
          addRandomParticlesInResampling_(true), randomParticlesRate_(0.1), randomParticlesNoise_({0.1, 0.1, 0.01}),
          odomNoiseDDM_({1.0, 0.5, 0.5, 1.0}), odomNoiseODM_({1.0, 0.5, 0.5, 0.5, 1.0, 0.5, 0.5, 0.5, 1.0}),
          deltaXSum_(0.0), deltaYSum_(0.0), deltaDistSum_(0.0), deltaYawSum_(0.0), deltaTimeSum_(0.0),
          ...
          zMax_(0.05), zRand_(0.05), varHit_(0.1), lambdaShort_(3.0), lambdaUnknown_(1.0), alphaSlow_(0.001),
          ...
          writePose_(false), poseLogFile_("/tmp/als_ros_pose.txt"), rad2deg_(180.0 / M_PI)
    {
